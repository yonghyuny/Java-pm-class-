...
public class Ex1_Variable {
	public static void main(String[] args) {
		...
		// 변수는 데이터를 실제로 담기 위한 컵
		
		// 변수의 선언
		// 자료형 변수명;
		
		// 값의 대입
		// 프로그래밍에서 =은 같다가 아닌 우측의 값을 좌측에 대입하겠다. 라는 의미를 갖고 있다.
		// 변수명 = 데이터;
		...
		*/
		...
		// userName   phoneNumber 등 띄어쓰기를 대문자로 표현
		
		// 스네이크 표기법(Snake case)
		// 모든 단어가 소문자로 시작하고, 단어와 단어 사이는_(언더바)로 표현하는 방식
		//user_name  phone_number 등 띄어쓰기를 언더바로 표현
		...
		b = false; // 대입, 대입은 몇번이고 다시 할 수 있다 그러나 대입하고나면 그 전에 값은 없어진다. 그리고 다른 타입의 값은 대입할 수 없다.
		System.out.println("b : " + b);
		...
		// float자료형을 사용한다는 것을 명시해줘야 한다.(뒤에 f를 붙여준다.)
		...
		System.out.println("yourAge : " + myAge);
